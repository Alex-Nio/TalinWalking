...
/* harmony import */ var _js_libs_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../../../js/libs/swiper-bundle.min */ "./src/js/libs/swiper-bundle.min.js");
/* harmony import */ var _js_libs_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_js_libs_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0__);
...
var swiper = new _js_libs_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0___default.a(".about-slider", {
...
var select = document.querySelector(".form-select__selector"),
...
var agreementCheckbox = document.querySelector(".agreement__checkbox");
var inputName = document.querySelector(".input-name"),
  inputEmail = document.querySelector(".input-email"),
  inputPhone = document.querySelector(".input-phone");
var inputNameController = inputName.nextElementSibling,
...
popup.addEventListener("click", function (e) {
  var target = e.target;
  if (!target.classList.contains("form-select__label") && selectLabel.classList.contains("active") && !target.classList.contains("form-select__title") && !target.classList.contains("arrow-icon")) {
    closeSelect();
  }
});
...
inputPhone.addEventListener("change", function () {
  var phoneRegex = /^\+?\d{1,3}[- ]?\d{1,3}[- ]?\d{2,5}$/;
...
function validateForm(e) {
  e.preventDefault();
  var selectValue = selectActiveValue.getAttribute("data-value");
  var nameRegex = /^[A-Za-zА-Яа-яЁё\s]+$/;
  var minLength = 2;
  if (inputName.value.length < minLength) {
    addError(inputName, "error");
...
/***/ "./src/blocks/modules/tours/tours.js":
/*!*******************************************!*\
  !*** ./src/blocks/modules/tours/tours.js ***!
  \*******************************************/
/*! no exports provided */
...
var swiper = new _js_libs_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0___default.a(".tours-slider", {
  direction: "horizontal",
  loop: false,
  autoplay: {
    enabled: false,
...
var addToFavBtns = document.querySelectorAll(".tour-card-control");
...
/* harmony import */ var _modules_tours_tours__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! %modules%/tours/tours */ "./src/blocks/modules/tours/tours.js");
